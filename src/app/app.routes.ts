  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./ActivityType/Components/add/add.component').then((m) => m.AddComponent),
      },
      {
        path: 'activity-types',
        loadComponent: () =>
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./NewLicenseStep/Components/new-license-management/new-license-management.component').then(
            (m) => m.NewLicenseManagementComponent,
          ),
      },
      {
        path: 'licensing-processes',
